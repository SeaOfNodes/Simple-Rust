...
fn test_while0() {
    let arena = Arena::new();
    let mut types = Types::new(&arena);
    let mut parser = Parser::new("while(0) continue; if(0) arg=0;", &mut types);
    let stop = parser.parse().unwrap();
    parser.iterate(stop);
    parser.show_graph();
    assert_eq!("Stop[ ]", parser.print(stop));
...
fn test_precedence() {
    let arena = Arena::new();
    let mut types = Types::new(&arena);
    let mut parser = Parser::new("return 3-1+2;", &mut types);
    let stop = parser.parse().unwrap();
    parser.iterate(stop);
    parser.show_graph();
...
fn test_swap2() {
    let arena = Arena::new();
    let mut types = Types::new(&arena);
    let mut parser = Parser::new("return 1+(1+1);", &mut types);
    let stop = parser.parse().unwrap();
    parser.iterate(stop);
    parser.show_graph();
...
fn test_fuzz2() {
    let arena = Arena::new();
    let mut types = Types::new(&arena);
    let mut parser = Parser::new("return 0+-0;", &mut types);
    let stop = parser.parse().unwrap();
    parser.iterate(stop);
    parser.show_graph();
    assert_eq!("return 0;", parser.print(stop));
...
fn test_fuzz3() {
    let arena = Arena::new();
    let mut types = Types::new(&arena);
    let mut parser = Parser::new("int v0=0; while(0==69) while(v0) return 0;", &mut types);
    let stop = parser.parse().unwrap();
    parser.iterate(stop);
    parser.show_graph();
    assert_eq!("Stop[ ]", parser.print(stop));
...
fn test_fuzz8() {
    let arena = Arena::new();
    let mut types = Types::new(&arena);
    let mut parser = Parser::new("while(arg) arg = arg - 1; #showGraph; return arg;", &mut types);
    let stop = parser.parse().unwrap();
    parser.iterate(stop);
    parser.show_graph();

...
impl<'a> Types<'a> {
    pub fn new(arena: &'a Arena<Type<'a>>) -> Self {
        ...
        let ty_i32 = interner.intern(Type::Integer(TyInteger {
            bits: 32,
            signed: true,
        }));
        let ty_i64 = interner.intern(Type::Integer(TyInteger {
            bits: 64,
            signed: true,
        }));
        ...
        Self {
            ...
            entries: HashMap::from([
                (ty_root_module, HashMap::from([("std", ty_std_module)])),
                (
                    ty_std_module,
                    HashMap::from([("bool", ty_bool), ("i32", ty_i32), ("i64", ty_i64)]),
                ),
            ]),
            ty_bool,
            ty_inferred,
    ...
    pub fn get_function_signature(
        ...
        self.interner
            .intern(Type::FunctionSignature(TyFunctionSignature {
                parameters,
                return_type,
            }))
    }
